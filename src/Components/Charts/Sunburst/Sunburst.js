  ...
  renderSunburst(props) {
    if (props.data) {
      const self = this, // eslint-disable-line
        ...
        svg = d3.select('.text-center').select('svg').append('g').attr('transform', `translate(${gWidth / 2},${gHeight / 2})`),
  ...
  render() {
    return (
      <div className="full-width-height">
        ...
        <br></br>
        <br></br>
        <h1 className="no-margin center">Zoomable Sunburst of cases in each state</h1>
        <br></br>
        <h3 className="no-margin center">Click on the state to view district wise share</h3>
        <br></br>
        <br></br>
        <br></br>
      <div id={this.props.keyId} className="text-center" style={{
    display: 'flex',
    alignItems: 'center',
